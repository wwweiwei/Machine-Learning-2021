...
'''
python hw3-3.py --B=1 --N=4 --S=1 --W 1 2 3 4
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--B', type=float, help='precision', default = 1)
    parser.add_argument('--N', type=int, help='basis number', default = 4)
    parser.add_argument('--S', type=float, help='variance', default = 1)
    parser.add_argument('--W', nargs='+', type=float, default = [1,2,3,4])
